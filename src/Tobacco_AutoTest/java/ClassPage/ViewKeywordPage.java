...
public class ViewKeywordPage {
    WebDriver driver;
    public String url_ListKeyword = "http://103.226.249.46:4000/keywords";

    public ViewKeywordPage(WebDriver driver){
        this.driver = driver;
    }

    public boolean ViewDetailKeyword(int row){
...
//        kiểm tra hiển thị màn view chi tiết thông qua title.
        return driver.findElement(By.xpath("/html/body/div[1]/div/section/ui-view/div/div/div/div[1]/h3")).isDisplayed();
    }
}
